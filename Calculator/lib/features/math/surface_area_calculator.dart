...
class _SurfaceAreaCalculatorState extends State<SurfaceAreaCalculator> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Surface Area Calculator'),
        leading: IconButton(
                  ...
                  child: Column(
                    children: [
                      DropdownButtonFormField<String>(
                        ...
                        items: ['Cube', 'Sphere', 'Cylinder', 'Box']
              ...
              if (_result != null) ...[
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Text('Surface Area', style: Theme.of(context).textTheme.titleMedium),
                        Text(
