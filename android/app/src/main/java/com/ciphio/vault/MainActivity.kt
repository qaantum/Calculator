...
import com.ciphio.vault.BuildConfig
import com.ciphio.vault.ui.CiphioApp
import com.ciphio.vault.ui.ExpirationScreen
...
class MainActivity : FragmentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            CiphioApp(initialSharedText = textToSet)
    ...
    private fun handleSharedText(intent: Intent?): String? {
        ...
        if (intent.action == Intent.ACTION_VIEW && intent.data != null) {
            ...
            // Check for "text" query parameter: ciphiovault://encrypt?text=Hello
    ...
    override fun onNewIntent(intent: Intent) {
        ...
        handleSharedText(intent)?.let { text ->
            ...
            // However, since we passed initialSharedText to CiphioApp, it only works on first launch.
