...
This directory contains unit tests for the Cryptatext iOS app.
...
4. If the test target is separate from the main app target, add this import at the top of each test file:
   ...
   ```
   (Replace `Cryptatext` with your actual app target name if different)

## Running Tests

- In Xcode: Product → Test (⌘U)
- Command line: `xcodebuild test -scheme CryptatextApp -destination 'platform=iOS Simulator,name=iPhone 15'`
