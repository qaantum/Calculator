...
final class PasswordVaultStore: ObservableObject {
    ...
    private let passwordsKey = "cryptatext.passwords"
    private let masterPasswordHashKey = "cryptatext.master_password_hash"
    private let biometricEnabledKey = "cryptatext.biometric_enabled"
    ...
    func hasMasterPassword() -> Bool {
        return defaults.string(forKey: masterPasswordHashKey) != nil
    }
