...
import com.cryptatext.crypto.AesMode
import com.cryptatext.ui.theme.LocalCryptatextColors
...
import com.cryptatext.data.HistoryEntry
import com.cryptatext.data.OperationType
import java.text.SimpleDateFormat
import java.util.Date
import java.util.Locale
import com.cryptatext.ui.theme.CryptatextColors
    ...
    Card(
        ...
        Column(
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(12.dp), modifier = Modifier.fillMaxWidth()) {
                ...
                val isEncryptActive = state.lastOperation == com.cryptatext.data.OperationType.ENCRYPT || state.lastOperation == null
                val isDecryptActive = state.lastOperation == com.cryptatext.data.OperationType.DECRYPT
...
private fun strengthColor(label: String, palette: CryptatextColors): Color = when (label.lowercase()) {
