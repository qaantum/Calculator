...
internal val AlgorithmsInfo: List<String> = listOf(
    "Cryptatext supports three AES block cipher modes to balance usability and security across scenarios.",
...
internal val TermsContent: List<String> = listOf(
    "Cryptatext operates entirely on your device. No text, keys, or history items are sent to external servers.",
    ...
    "By using Cryptatext you acknowledge that the developers are not liable for data loss, misuse, or damages arising from the app's use.",
