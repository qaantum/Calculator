...
1. **Data Collection**: What data you collect (if any)
   - For Ciphio: All data is stored locally, no data collection
2. **Data Storage**: Where data is stored
   - For Ciphio: All data stored locally on device
3. **Data Sharing**: Who you share data with
   - For Ciphio: No data sharing (everything is local)
4. **Encryption**: How you protect data
   - For Ciphio: Client-side encryption using AES
...
1. **GitHub Pages** (free)
   ...
   - URL: `https://yourusername.github.io/ciphio/privacy-policy.html`
...
```bash
cd android/app
keytool -genkey -v -keystore ciphio-release.jks \
...
### App Name
- **Android**: "Ciphio" (max 50 chars)
- **iOS**: "Ciphio" (max 30 chars)
