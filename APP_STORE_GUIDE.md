...
Complete guide for submitting Cryptatext to Google Play Store and Apple App Store.
...
4. **Release notes:**
   - What's new in this version: "Initial release of Cryptatext"
...
3. Fill in:
   ...
   - **Bundle ID**: com.cryptatext (must match your Xcode project)
   - **SKU**: cryptatext-001 (unique identifier)
...
5. **Version Information:**
   ...
   - **What's New**: "Initial release of Cryptatext"
...
2. **Demo Account:**
   - Not required for Cryptatext (no login needed)
