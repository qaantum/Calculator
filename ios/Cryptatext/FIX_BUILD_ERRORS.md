...
2. **For each file:**
   ...
   - **Check the box** next to **"Cryptatext"** (the app target)
   - Make sure **"CryptatextTests"** and **"CryptatextUITests"** are **unchecked** (unless you want them in tests)

3. **Verify all files are checked:**
   - All 7 Swift files should have "Cryptatext" checked in Target Membership
...
1. **Select all Swift files** in Finder:
   - Navigate to `/Users/qaantum/Desktop/Project/ios/Cryptatext/Cryptatext/`
   - Select all 7 `.swift` files

2. **Drag and drop into Xcode:**
   - Drag files into the `Cryptatext` folder in Xcode
   - In the dialog:
     - **Uncheck** "Copy items if needed"
     - **Check** "Add to targets: Cryptatext"
     - **Uncheck** "CryptatextTests" and "CryptatextUITests"
   - Click **"Finish"**

### Set Deployment Target

1. Click **"Cryptatext"** project (blue icon at top)
2. Select **"Cryptatext"** target (under TARGETS)
3. Go to **"General"** tab
